...
class Init_LimoSrv_Event_response
{
public:
  explicit Init_LimoSrv_Event_response(::limo_msgs::srv::LimoSrv_Event & msg)
  : msg_(msg)
  {}
  ::limo_msgs::srv::LimoSrv_Event response(::limo_msgs::srv::LimoSrv_Event::_response_type arg)
  {
...
private:
  ::limo_msgs::srv::LimoSrv_Event msg_;
};

class Init_LimoSrv_Event_request
{
public:
  explicit Init_LimoSrv_Event_request(::limo_msgs::srv::LimoSrv_Event & msg)
  : msg_(msg)
  {}
  Init_LimoSrv_Event_response request(::limo_msgs::srv::LimoSrv_Event::_request_type arg)
  {
    msg_.request = std::move(arg);
    return Init_LimoSrv_Event_response(msg_);
  }
...
class Init_LimoSrv_Event_info
{
public:
  Init_LimoSrv_Event_info()
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_LimoSrv_Event_request info(::limo_msgs::srv::LimoSrv_Event::_info_type arg)
  {
    msg_.info = std::move(arg);
    return Init_LimoSrv_Event_request(msg_);
  }
...
template<>
inline
auto build<::limo_msgs::srv::LimoSrv_Event>()
{
  return limo_msgs::srv::builder::Init_LimoSrv_Event_info();
}
