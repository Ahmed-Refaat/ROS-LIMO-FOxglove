...
class Init_LimoAction_SendGoal_Event_response
{
public:
  explicit Init_LimoAction_SendGoal_Event_response(::limo_msgs::action::LimoAction_SendGoal_Event & msg)
  : msg_(msg)
  {}
  ::limo_msgs::action::LimoAction_SendGoal_Event response(::limo_msgs::action::LimoAction_SendGoal_Event::_response_type arg)
  {
...
private:
  ::limo_msgs::action::LimoAction_SendGoal_Event msg_;
};

class Init_LimoAction_SendGoal_Event_request
{
public:
  explicit Init_LimoAction_SendGoal_Event_request(::limo_msgs::action::LimoAction_SendGoal_Event & msg)
  : msg_(msg)
  {}
  Init_LimoAction_SendGoal_Event_response request(::limo_msgs::action::LimoAction_SendGoal_Event::_request_type arg)
  {
    msg_.request = std::move(arg);
    return Init_LimoAction_SendGoal_Event_response(msg_);
  }
...
class Init_LimoAction_SendGoal_Event_info
{
public:
  Init_LimoAction_SendGoal_Event_info()
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_LimoAction_SendGoal_Event_request info(::limo_msgs::action::LimoAction_SendGoal_Event::_info_type arg)
  {
    msg_.info = std::move(arg);
    return Init_LimoAction_SendGoal_Event_request(msg_);
  }
...
template<>
inline
auto build<::limo_msgs::action::LimoAction_SendGoal_Event>()
{
  return limo_msgs::action::builder::Init_LimoAction_SendGoal_Event_info();
}
...
class Init_LimoAction_GetResult_Event_response
{
public:
  explicit Init_LimoAction_GetResult_Event_response(::limo_msgs::action::LimoAction_GetResult_Event & msg)
  : msg_(msg)
  {}
  ::limo_msgs::action::LimoAction_GetResult_Event response(::limo_msgs::action::LimoAction_GetResult_Event::_response_type arg)
  {
    msg_.response = std::move(arg);
    return std::move(msg_);
  }
...
private:
  ::limo_msgs::action::LimoAction_GetResult_Event msg_;
};

class Init_LimoAction_GetResult_Event_request
{
public:
  explicit Init_LimoAction_GetResult_Event_request(::limo_msgs::action::LimoAction_GetResult_Event & msg)
  : msg_(msg)
  {}
  Init_LimoAction_GetResult_Event_response request(::limo_msgs::action::LimoAction_GetResult_Event::_request_type arg)
  {
    msg_.request = std::move(arg);
    return Init_LimoAction_GetResult_Event_response(msg_);
  }
...
class Init_LimoAction_GetResult_Event_info
{
public:
  Init_LimoAction_GetResult_Event_info()
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_LimoAction_GetResult_Event_request info(::limo_msgs::action::LimoAction_GetResult_Event::_info_type arg)
  {
    msg_.info = std::move(arg);
    return Init_LimoAction_GetResult_Event_request(msg_);
  }
...
template<>
inline
auto build<::limo_msgs::action::LimoAction_GetResult_Event>()
{
  return limo_msgs::action::builder::Init_LimoAction_GetResult_Event_info();
}
