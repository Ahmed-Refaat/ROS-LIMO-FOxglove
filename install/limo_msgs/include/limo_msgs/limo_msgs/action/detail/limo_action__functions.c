...
limo_msgs__action__LimoAction_SendGoal_Event__init(limo_msgs__action__LimoAction_SendGoal_Event * msg)
{
  ...
  if (!service_msgs__msg__ServiceEventInfo__init(&msg->info)) {
    limo_msgs__action__LimoAction_SendGoal_Event__fini(msg);
    return false;
  }
  // request
  if (!limo_msgs__action__LimoAction_SendGoal_Request__Sequence__init(&msg->request, 0)) {
    limo_msgs__action__LimoAction_SendGoal_Event__fini(msg);
    return false;
  }
  // response
  if (!limo_msgs__action__LimoAction_SendGoal_Response__Sequence__init(&msg->response, 0)) {
    limo_msgs__action__LimoAction_SendGoal_Event__fini(msg);
    return false;
  }
  return true;
...
limo_msgs__action__LimoAction_SendGoal_Event__fini(limo_msgs__action__LimoAction_SendGoal_Event * msg)
{
  ...
  // request
  limo_msgs__action__LimoAction_SendGoal_Request__Sequence__fini(&msg->request);
  // response
  limo_msgs__action__LimoAction_SendGoal_Response__Sequence__fini(&msg->response);
}
...
limo_msgs__action__LimoAction_SendGoal_Event__are_equal(const limo_msgs__action__LimoAction_SendGoal_Event * lhs, const limo_msgs__action__LimoAction_SendGoal_Event * rhs)
{
  ...
  // request
  if (!limo_msgs__action__LimoAction_SendGoal_Request__Sequence__are_equal(
      &(lhs->request), &(rhs->request)))
  {
    return false;
  }
  // response
  if (!limo_msgs__action__LimoAction_SendGoal_Response__Sequence__are_equal(
  ...
  limo_msgs__action__LimoAction_SendGoal_Event * output)
{
  ...
  // request
  if (!limo_msgs__action__LimoAction_SendGoal_Request__Sequence__copy(
      &(input->request), &(output->request)))
  {
    return false;
  }
  // response
  if (!limo_msgs__action__LimoAction_SendGoal_Response__Sequence__copy(
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  limo_msgs__action__LimoAction_SendGoal_Event * msg = (limo_msgs__action__LimoAction_SendGoal_Event *)allocator.allocate(sizeof(limo_msgs__action__LimoAction_SendGoal_Event), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(limo_msgs__action__LimoAction_SendGoal_Event));
  bool success = limo_msgs__action__LimoAction_SendGoal_Event__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
limo_msgs__action__LimoAction_SendGoal_Event__Sequence__init(limo_msgs__action__LimoAction_SendGoal_Event__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  limo_msgs__action__LimoAction_SendGoal_Event * data = NULL;

  if (size) {
    data = (limo_msgs__action__LimoAction_SendGoal_Event *)allocator.zero_allocate(size, sizeof(limo_msgs__action__LimoAction_SendGoal_Event), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = limo_msgs__action__LimoAction_SendGoal_Event__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        limo_msgs__action__LimoAction_SendGoal_Event__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
limo_msgs__action__LimoAction_SendGoal_Event__Sequence__fini(limo_msgs__action__LimoAction_SendGoal_Event__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      limo_msgs__action__LimoAction_SendGoal_Event__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  limo_msgs__action__LimoAction_SendGoal_Event__Sequence * array = (limo_msgs__action__LimoAction_SendGoal_Event__Sequence *)allocator.allocate(sizeof(limo_msgs__action__LimoAction_SendGoal_Event__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = limo_msgs__action__LimoAction_SendGoal_Event__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
limo_msgs__action__LimoAction_SendGoal_Event__Sequence__destroy(limo_msgs__action__LimoAction_SendGoal_Event__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    limo_msgs__action__LimoAction_SendGoal_Event__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
limo_msgs__action__LimoAction_SendGoal_Event__Sequence__are_equal(const limo_msgs__action__LimoAction_SendGoal_Event__Sequence * lhs, const limo_msgs__action__LimoAction_SendGoal_Event__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!limo_msgs__action__LimoAction_SendGoal_Event__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  limo_msgs__action__LimoAction_SendGoal_Event__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(limo_msgs__action__LimoAction_SendGoal_Event);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    limo_msgs__action__LimoAction_SendGoal_Event * data =
      (limo_msgs__action__LimoAction_SendGoal_Event *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!limo_msgs__action__LimoAction_SendGoal_Event__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          limo_msgs__action__LimoAction_SendGoal_Event__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!limo_msgs__action__LimoAction_SendGoal_Event__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
limo_msgs__action__LimoAction_GetResult_Event__init(limo_msgs__action__LimoAction_GetResult_Event * msg)
{
  ...
  // info
  if (!service_msgs__msg__ServiceEventInfo__init(&msg->info)) {
    limo_msgs__action__LimoAction_GetResult_Event__fini(msg);
    return false;
  }
  // request
  if (!limo_msgs__action__LimoAction_GetResult_Request__Sequence__init(&msg->request, 0)) {
    limo_msgs__action__LimoAction_GetResult_Event__fini(msg);
    return false;
  }
  // response
  if (!limo_msgs__action__LimoAction_GetResult_Response__Sequence__init(&msg->response, 0)) {
    limo_msgs__action__LimoAction_GetResult_Event__fini(msg);
    return false;
  }
  return true;
...
limo_msgs__action__LimoAction_GetResult_Event__fini(limo_msgs__action__LimoAction_GetResult_Event * msg)
{
  ...
  service_msgs__msg__ServiceEventInfo__fini(&msg->info);
  // request
  limo_msgs__action__LimoAction_GetResult_Request__Sequence__fini(&msg->request);
  // response
  limo_msgs__action__LimoAction_GetResult_Response__Sequence__fini(&msg->response);
}
...
limo_msgs__action__LimoAction_GetResult_Event__are_equal(const limo_msgs__action__LimoAction_GetResult_Event * lhs, const limo_msgs__action__LimoAction_GetResult_Event * rhs)
{
  ...
  // request
  if (!limo_msgs__action__LimoAction_GetResult_Request__Sequence__are_equal(
      &(lhs->request), &(rhs->request)))
  {
    return false;
  }
  // response
  if (!limo_msgs__action__LimoAction_GetResult_Response__Sequence__are_equal(
      &(lhs->response), &(rhs->response)))
  {
    return false;
  }
  ...
  limo_msgs__action__LimoAction_GetResult_Event * output)
{
  ...
  // request
  if (!limo_msgs__action__LimoAction_GetResult_Request__Sequence__copy(
      &(input->request), &(output->request)))
  {
    return false;
  }
  // response
  if (!limo_msgs__action__LimoAction_GetResult_Response__Sequence__copy(
      &(input->response), &(output->response)))
  {
    return false;
  }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  limo_msgs__action__LimoAction_GetResult_Event * msg = (limo_msgs__action__LimoAction_GetResult_Event *)allocator.allocate(sizeof(limo_msgs__action__LimoAction_GetResult_Event), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(limo_msgs__action__LimoAction_GetResult_Event));
  bool success = limo_msgs__action__LimoAction_GetResult_Event__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
limo_msgs__action__LimoAction_GetResult_Event__Sequence__init(limo_msgs__action__LimoAction_GetResult_Event__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  limo_msgs__action__LimoAction_GetResult_Event * data = NULL;

  if (size) {
    data = (limo_msgs__action__LimoAction_GetResult_Event *)allocator.zero_allocate(size, sizeof(limo_msgs__action__LimoAction_GetResult_Event), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = limo_msgs__action__LimoAction_GetResult_Event__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        limo_msgs__action__LimoAction_GetResult_Event__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
limo_msgs__action__LimoAction_GetResult_Event__Sequence__fini(limo_msgs__action__LimoAction_GetResult_Event__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      limo_msgs__action__LimoAction_GetResult_Event__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  limo_msgs__action__LimoAction_GetResult_Event__Sequence * array = (limo_msgs__action__LimoAction_GetResult_Event__Sequence *)allocator.allocate(sizeof(limo_msgs__action__LimoAction_GetResult_Event__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = limo_msgs__action__LimoAction_GetResult_Event__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
limo_msgs__action__LimoAction_GetResult_Event__Sequence__destroy(limo_msgs__action__LimoAction_GetResult_Event__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    limo_msgs__action__LimoAction_GetResult_Event__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
limo_msgs__action__LimoAction_GetResult_Event__Sequence__are_equal(const limo_msgs__action__LimoAction_GetResult_Event__Sequence * lhs, const limo_msgs__action__LimoAction_GetResult_Event__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!limo_msgs__action__LimoAction_GetResult_Event__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  limo_msgs__action__LimoAction_GetResult_Event__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(limo_msgs__action__LimoAction_GetResult_Event);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    limo_msgs__action__LimoAction_GetResult_Event * data =
      (limo_msgs__action__LimoAction_GetResult_Event *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!limo_msgs__action__LimoAction_GetResult_Event__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          limo_msgs__action__LimoAction_GetResult_Event__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!limo_msgs__action__LimoAction_GetResult_Event__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
