...
enum
{
  limo_msgs__action__LimoAction_SendGoal_Event__request__MAX_SIZE = 1
};
// response
enum
{
  limo_msgs__action__LimoAction_SendGoal_Event__response__MAX_SIZE = 1
};

/// Struct defined in action/LimoAction in the package limo_msgs.
typedef struct limo_msgs__action__LimoAction_SendGoal_Event
{
  service_msgs__msg__ServiceEventInfo info;
  limo_msgs__action__LimoAction_SendGoal_Request__Sequence request;
  limo_msgs__action__LimoAction_SendGoal_Response__Sequence response;
} limo_msgs__action__LimoAction_SendGoal_Event;

// Struct for a sequence of limo_msgs__action__LimoAction_SendGoal_Event.
typedef struct limo_msgs__action__LimoAction_SendGoal_Event__Sequence
{
...
enum
{
  limo_msgs__action__LimoAction_GetResult_Event__request__MAX_SIZE = 1
};
// response
enum
{
  limo_msgs__action__LimoAction_GetResult_Event__response__MAX_SIZE = 1
};

/// Struct defined in action/LimoAction in the package limo_msgs.
typedef struct limo_msgs__action__LimoAction_GetResult_Event
{
  service_msgs__msg__ServiceEventInfo info;
  limo_msgs__action__LimoAction_GetResult_Request__Sequence request;
  limo_msgs__action__LimoAction_GetResult_Response__Sequence response;
} limo_msgs__action__LimoAction_GetResult_Event;

// Struct for a sequence of limo_msgs__action__LimoAction_GetResult_Event.
typedef struct limo_msgs__action__LimoAction_GetResult_Event__Sequence
{
